...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'AWAITING_PAYMENT', 'PROCESSING', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'FAILED', 'REFUNDED');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('ORDER_CONFIRMATION', 'ORDER_SHIPPED', 'ORDER_DELIVERED', 'ORDER_CANCELLED_USER', 'PASSWORD_RESET_REQUEST', 'ACCOUNT_UPDATED', 'NEW_ORDER_PLACED_ADMIN', 'LOW_STOCK_WARNING_ADMIN', 'ORDER_CANCELLED_BY_USER_ADMIN', 'NEW_USER_REGISTERED_ADMIN', 'PRODUCT_REVIEW_SUBMITTED_ADMIN', 'CONTACT_FORM_SUBMITTED_ADMIN');
