...
export const metadata: Metadata = {
  title: "Termini e Condizioni | Cartoleria Bambù",
  description:
...
export default function TermsPage() {
  return (
    <div className="min-h-screen bg-[#f8fbfa] py-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="space-y-6 text-gray-700 leading-relaxed">
            <section>
              ...
              <p>
                Questo sito web è gestito da Cartoleria Bambù. I termini &quot;noi&quot; e
                &quot;nostro&quot; all&apos;interno del sito si riferiscono a Cartoleria Bambù.
                Cartoleria Bambù ti offre questo sito web con tutte le
                informazioni, gli strumenti e i servizi in esso disponibili a
                condizione che tu, in qualità di utente, accetti tutti i
                termini, le condizioni, le informative e le avvertenze qui
                riportate.
              </p>
              <p>
                Visitando il nostro sito e/o acquistando qualcosa da noi,
                usufruisci del nostro &quot;Servizio&quot; e accetti di essere vincolato
                dai seguenti termini e condizioni (&quot;Termini e condizioni del
                servizio&quot;, &quot;Termini&quot;), che includono i termini, le condizioni e
                le informative aggiuntive citate nel presente documento e/o
                disponibili tramite collegamento ipertestuale. I presenti
                Termini e condizioni del servizio si applicano a tutti gli
                utenti del sito, compresi a titolo esemplificativo e non
                esaustivo visitatori, fornitori, clienti, commercianti e/o
                autori di commenti e altri contenuti.
              </p>
              <p>
              ...
              <p>
                ...
                condizioni del servizio in qualsiasi momento su questa pagina.
                Ci riserviamo il diritto di aggiornare, modificare o sostituire
                qualsiasi parte dei Termini e condizioni del servizio
                pubblicando aggiornamenti e/o modifiche sul nostro sito web. È
                tua responsabilità controllare periodicamente questa pagina per
                vedere se sono presenti delle modifiche. La prosecuzione
                dell&apos;utilizzo o dell&apos;accesso al sito web dopo la pubblicazione
            ...
            <section>
              ...
              <p>
                ...
                autorizzati né puoi, nell&apos;uso del Servizio, violare alcuna legge
                vigente nel tuo ordinamento (incluse a puro titolo
            ...
            <section>
              ...
              <p>
                ...
                rivendere o sfruttare alcuna parte del Servizio, né l&apos;uso del
                Servizio, l&apos;accesso al Servizio o qualsiasi contatto sul sito
                web attraverso il quale il servizio è fornito senza espressa
            ...
            <section>
              ...
              <p>
                Questo sito può contenere alcune informazioni di carattere storico. Le informazioni storiche, necessariamente, non sono attuali e sono fornite solo come riferimento. Ci riserviamo il diritto di modificare i contenuti di questo sito in qualsiasi
                momento, ma non siamo soggetti all&apos;obbligo di aggiornare alcuna
                informazione sul nostro sito. Accetti che è tua responsabilità monitorare le modifiche al nostro sito.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Ci riserviamo il diritto di interrompere in ogni momento la vendita di un qualsiasi prodotto. La vendita di qualsiasi prodotto o servizio tramite questo sito è da considerarsi nulla laddove sia proibita.
              </p>
              <p>
                Non garantiamo che la qualità di prodotti, servizi, informazioni o altri materiali da te acquistati o ottenuti soddisfi le tue aspettative, né che gli eventuali errori del Servizio vengano corretti.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                l&apos;indirizzo email, l&apos;indirizzo di fatturazione o il numero di
                telefono forniti al momento dell&apos;ordine. Ci riserviamo il
                diritto di limitare o vietare ordini che a nostro insindacabile giudizio sembrino effettuati da grossisti, rivenditori o distributori.
              </p>
              <p>
                Accetti di fornire informazioni aggiornate, complete e accurate
                sull&apos;acquisto e sull&apos;account per tutti gli acquisti effettuati
                nel nostro negozio. Accetti di aggiornare tempestivamente il tuo
                account e altri dettagli, come l&apos;indirizzo email, il numero e la
                data di scadenza delle carte di credito, in modo che possiamo completare le transazioni e contattarti se necessario.
              </p>
              <p>
            ...
            <section>
              ...
              <p>
                ...
                monitoriamo e sui quali non abbiamo alcuna forma di controllo o gestione.
              </p>
              <p>
            ...
            <section>
              ...
              <p>
                I link di terze parti su questo sito potranno indirizzarti a siti web esterni, che non sono affiliati con noi. Noi non siamo
                responsabili di esaminare o valutare i contenuti o l&apos;esattezza
                di tali siti web. E non forniamo alcuna garanzia né abbiamo alcuna responsabilità per materiali o siti web di terze parti né per altri materiali, prodotti o servizi di terze parti.
              </p>
              <p>
            ...
            <section>
              ...
              <p>
                Accetti di evitare commenti che ledano i diritti di terze parti, tra cui copyright, marchi commerciali, diritto alla privacy, diritti della personalità e altri diritti reali o personali. Inoltre accetti di non inviare commenti che contengano materiale diffamatorio o altrimenti illegale, offensivo o obsceno, oppure virus informatici o altri malware che rischiano di compromettere il funzionamento del Servizio o di qualsiasi sito web correlato. Non potrai utilizzare un indirizzo email falso, fingere di essere qualcun altro o altrimenti fuorviare noi o terze parti
                sull&apos;origine di eventuali commenti. Sei l&apos;unico responsabile dei
                commenti che invii e della loro accuratezza. Non ci assumiamo e non avremo alcuna responsabilità per eventuali commenti pubblicati da te o da terze parti.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                regolato dalla nostra Informativa sulla privacy. Per visualizzare la nostra Informativa sulla privacy, consulta i link nel footer del sito.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>(b) per indurre altri a compiere o partecipare ad atti illeciti;</li>
                <li>(c) per violare leggi e regolamenti internazionali, federali, provinciali o statali, o ordinanze locali;</li>
                <li>(d) per ledere o violare i diritti di proprietà intellettuale nostri o di terzi;</li>
                <li>(e) per molestare, abusare, insultare, danneggiare, diffamare, calunniare, denigrare, intimidire o discriminare qualcuno in base a sesso, orientamento sessuale, religione, etnia, età, paese di origine o disabilità;</li>
                <li>(f) per fornire informazioni false o fuorvianti;</li>
                <li>(g) per caricare o trasmettere virus o qualsiasi altro tipo di codice dannoso idoneo a influire sulla funzionalità o sul funzionamento del Servizio, di qualsiasi sito web correlato, di altri siti web o di internet;</li>
                <li>(h) per raccogliere o monitorare le informazioni personali di altri utenti;</li>
                <li>(i) per spam, phishing, pharming, pretexting, uso di spider, crawling o scraping;</li>
                <li>(j) per qualsiasi scopo obsceno o immorale;</li>
                <li>(k) per intralciare o aggirare le funzionalità di sicurezza del Servizio o di qualsiasi sito web correlato, di altri siti web o di internet.</li>
              </ul>
              <p>
                Ci riserviamo il diritto di interrompere il tuo utilizzo del Servizio o di qualsiasi sito web correlato se violi una qualsiasi delle disposizioni sugli usi proibiti.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                responsabilità oggettiva o altro — derivante dall&apos;utilizzo di
                uno qualsiasi dei servizi o prodotti ottenuti utilizzando il
                servizio.
              </p>
              <p>
                Poiché alcuni stati o giurisdizioni non consentono l&apos;esclusione
                o la limitazione di responsabilità per danni conseguenti o
                incidentali, in tali stati o giurisdizioni la nostra
                responsabilità sarà limitata fino al limite massimo consentito
                dalla legge.
              </p>
            </section>
