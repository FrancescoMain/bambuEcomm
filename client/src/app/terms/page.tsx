          ...
          <div className="space-y-6 text-gray-700 leading-relaxed">
            ...
            <section>
              ...
              <p>
                ...
                monitorare le modifiche al nostro sito.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                diritto di limitare o vietare ordini che a nostro insindacabile
                giudizio sembrino effettuati da grossisti, rivenditori o
                distributori.
              </p>
              <p>
                ...
                data di scadenza delle carte di credito, in modo che possiamo
                completare le transazioni e contattarti se necessario.
              </p>
              <p>
            ...
            <section>
              ...
              <p>
                ...
                "così come sono" e "come disponibili", senza alcun tipo di
                garanzia, dichiarazione, condizione o avallo. Non avremo alcuna
                responsabilità derivante da o relativa al tuo utilizzo di
                strumenti opzionali di terze parti.
              </p>
              <p>
            ...
            <section>
              ...
              <p>
                ...
                di tali siti web. E non forniamo alcuna garanzia né abbiamo
                alcuna responsabilità per materiali o siti web di terze parti né
                per altri materiali, prodotti o servizi di terze parti.
              </p>
              <p>
                Non risponderemo di eventuali danni connessi all'acquisto o
                all'utilizzo di beni, servizi, risorse, contenuti o a qualsiasi
                altra transazione effettuata attraverso siti web di terze parti.
                Esamina attentamente le policy e le procedure di terze parti e
                assicurati di averle comprese prima di effettuare qualsiasi
                transazione. Reclami, richieste, dubbi e domande sui prodotti di
                terze parti dovranno essere indirizzati ai terzi interessati.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                "commenti") — ad esempio, su nostra richiesta, contributi per la
                partecipazione a concorsi, oppure senza una nostra richiesta,
                idee creative, suggerimenti, proposte, piani o altri materiali —
                accetti che possiamo in qualsiasi momento e senza limitazioni
                modificare, copiare, pubblicare, distribuire, tradurre o
                utilizzare in qualsiasi altro modo e con qualsiasi mezzo i
                commenti che ci trasmetti. Non abbiamo e non avremo alcun
                obbligo di (1) mantenere riservati i commenti; (2) pagare
              ...
              <p>
                ...
                diffamatorio o altrimenti illegale, offensivo o osceno, oppure
                ...
                commenti che invii e della loro accuratezza. Non ci assumiamo e
                non avremo alcuna responsabilità per eventuali commenti
                pubblicati da te o da terze parti.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>(j) per qualsiasi scopo osceno o immorale;</li>
                <li>
